    ...
    <div className='flex h-screen bg-gray-200'>
      ...
      >
        ...
        <Menu.Nav>
          ...
          <Menu.NavItem href='/categories'>Categories</Menu.NavItem>
          <Menu.NavItem href='/products'>Products</Menu.NavItem>
          <Menu.NavItem href='/brands'>Brands</Menu.NavItem>
        </Menu.Nav>
      </div>
          ...
          <div className='flex items-center'>
            <div className='relative'>
              <button
                ...
                className='flex p-2 mx-4 text-gray-600 focus:outline-none'
              >
                <svg
                  className='h-6 w-6'
                  viewBox='0 0 24 24'
              ...
              <div
                className={
                  'absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl overflow-hidden ' +
                  (notificationOpen ? ' ' : 'hidden ')
                }
              >
                <a
                  href='#'
                  className='block items-center px-4 py-3 text-gray-600 hover:text-white hover:bg-indigo-600 -mx-2'
                >
                  <img
            ...
            <div className='relative p-2 mx-2'>
              <button
